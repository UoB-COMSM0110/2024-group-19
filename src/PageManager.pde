public class PageManager{
  ...
  text("Mouse to aim \nand shoot", baseX, baseY + 1.3 * offset);
  textSize(50);
  image(buttonImage, (width/3), height*0.72, width*0.2, height*0.13);// "Click to Start"
  textLeading(37);
  text("Enter to\nResume",(width*0.33), height*0.71);
  textSize(50);
  image(buttonImage, (width*0.7), height*0.72, width*0.2, height*0.13);// "Click to Start"
